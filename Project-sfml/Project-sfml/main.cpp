/*! \mainpage Sea Battle game
 *
 * \section intro_sec Introduction
 *
 * This is a standart game called Sea Battle
 * Main feature of this realization is that you can play not only with another player but also with bot.\n
 * Bot has quite smart algorithm to detect best cells for attack so it is not easy to win against it.\n
 * Try it)\n
 */
